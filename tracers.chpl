...
//    kappa_v[D.rho_3D] = get_var(P.velfiles[P.Nt_start], "Akt", D.rho_3D);
    kappa_v[D.rho_3D] = readZarrArrayLocal(P.velfiles[P.Nt_start] + (here.id : string) + '/Akt/', real(32), 4);

    // Initialize tracer fields
//    tracer_n[D.rho_3D] = get_var(P.velfiles[P.Nt_start], "temp", D.rho_3D);
    tracer_n[D.rho_3D] = readZarrArrayLocal(P.velfiles[P.Nt_start] + (here.id : string) + '/temp/', real(32), 4);
...
//    zeta[D.rho_2D] = get_var(P.velfiles[step], "zeta", D.rho_2D);
    zeta[D.rho_2D] = readZarrArrayLocal(P.velfiles[step] + (here.id : string) + '/zeta/', real(32), 3);
