...
config const gridfile       = '/pscratch/sd/s/sbachman/chapel_experiments/offline_BGC/convert_to_Zarr/INPUT/Iceland1_grd.nc';
config const velocity_files = '/pscratch/sd/s/sbachman/chapel_experiments/offline_BGC/convert_to_Zarr/INPUT/Iceland1_avg.??????????????.zarr';
config const boundary_files = '/pscratch/sd/s/sbachman/chapel_experiments/offline_BGC/convert_to_Zarr/INPUT/Iceland1_bry.??????????????.nc';
config const forcing_files  = '/pscratch/sd/s/sbachman/chapel_experiments/offline_BGC/convert_to_Zarr/INPUT/Iceland1_bry.??????????????.nc';
